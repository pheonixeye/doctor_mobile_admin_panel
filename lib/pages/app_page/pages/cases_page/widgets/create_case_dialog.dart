...
class _CreateCaseDialogState extends State<CreateCaseDialog> {
  final formKey = GlobalKey<FormState>(debugLabel: 'case-create-form');
  ...
  Widget build(BuildContext context) {
    return AlertDialog.adaptive(
      title: GenericDialogTitle(title: context.loc.createCase),
          ...
          onPressed: () {
            if (formKey.currentState!.validate()) {
              final _case = Case(
                ...
                name_en: _titleEnController.text,
                name_ar: _titleArController.text,
                description_en: _descEnController.text,
                description_ar: _descArController.text,
                pre_image: '',
                post_image: '',
              );
              Navigator.pop(context, _case);
            }
          },
